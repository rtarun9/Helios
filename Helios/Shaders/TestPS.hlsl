...
float4 PsMain(VSOutput input) : SV_Target
{
    ...
    float3 shadedColor = specular * highLightColor + (1.0f - specular) * (lerp(angle, warmColor, coolColor));
//    shadedColor = surfaceColor * angle + surfaceColor * 0.1f + surfaceColor * specular;
