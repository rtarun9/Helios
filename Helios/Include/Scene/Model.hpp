...
namespace helios::scene
{
    ...
    // note(rtarun9) : For now, the Model will have ownership of meshes and materials, in future move these to the ResourceManager and just obtain
    // pointers to them, hence sharing them between all models.
    class Model
    {
      public:
        Model() = default;
        ...
        void render(const gfx::GraphicsContext* const graphicsContext, interlop::ModelViewerRenderResources& renderResources) const;

      private:
        void loadNode(const gfx::GraphicsDevice* const graphicsDevice, const ModelCreationDesc& modelCreationDesc, const uint32_t nodeIndex,
