...
{
    // Provides functions to compute the view matrix that can be used to transform world space coordinates into view space coordinates.
    class Camera
    {
      public:
        // note(rtarun9) : Not defining any special functions (constructor, destructor, etc), since it is not really required here.
