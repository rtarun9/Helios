...
namespace helios::scene
{
	...
	// Also handles rendering of skybox, and creation and processing of all other maps (irradiance, prefiltered, brdf LUT etc).
	...
	public:
		...
		std::unique_ptr<gfx::PipelineState> mBRDFLutPipelineState{};
		...
		std::unique_ptr<gfx::Texture> mBRDFLutTexture;
	};
}
