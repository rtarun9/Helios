// note(rtarun9) : Could just use a texture as the BRDF lut is independent on the actual environment cube map texture, but its here just for reference,
// the math here is *way* to complex for me.
...
ConstantBuffer<BRDFLutRenderResources> renderResources : register(b0);
